            ...
            <div className="footer-feature">
                ...
                <div className="footer-contact-container">
                                ...
                                staticData.contactInfo.socialMedia.map((list,i)=>{
                                    return(
                                        <a key={`socialMedia_${i}`} href={list.url}>
                                            <i className={`media-icon ${list.fontIcon}`}></i>
                                        </a>
                                    )
                                })
                            }
                    ...
                    <div className="mail-address">
                        ...
                        <p>{staticData.mailAddress.address.title}<a href={staticData.mailAddress.address.url}>{staticData.mailAddress.address.content}</a></p>
                    </div>
                </div>
            </div>
        </div>
